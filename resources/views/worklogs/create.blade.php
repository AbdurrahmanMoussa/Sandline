      ...
      <form class="col-sm-6" action="{{ route('worklogs.store') }}" method="POST" autocomplete="off">
        ...
        @else
          ...
          <div class="form-group mt-4">
            ...
            <input type="date" id="worklogdate" name="worklogdate" class="form-control" required readonly>
            @error('worklogdate')
              <span class="text-danger">
                <strong>{{ $message }}</strong>
              </span>
          ...
          <div class="form-group mt-4">
            ...
            <input type="time" name="timer" id="timer" placeholder="Select time" class="form-control" required readonly>
            @error('timer')
              <span class="text-danger">
                <strong>{{ $message }}</strong>
              </span>
